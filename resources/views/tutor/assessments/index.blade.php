                    ...
                    <div id="questions-container">
                        ...
                        <div class="question-block card mb-4 rounded-xl bg-gray-700 p-4">
                            <div class="card-body text-black">
                                ...
                                <input type="text" name="questions[0][question]" class="form-control mb-3" required>
                                    ...
                                    <div class="multiple-choice-answers text-black">
                                        ...
                                        <div class="form-check mb-3">
                                            <input type="text" name="questions[0][answers][0]"
                                                class="form-control mb-2" placeholder="Answer 1" required>
                                        ...
                                        <div class="form-check mb-3">
                                            <input type="text" name="questions[0][answers][1]"
                                                class="form-control mb-2" placeholder="Answer 2" required>
                                        ...
                                        <div class="form-check mb-3">
                                            <input type="text" name="questions[0][answers][2]"
                                                class="form-control mb-2" placeholder="Answer 3" required>
                                        ...
                                        <div class="form-check mb-3">
                                            <input type="text" name="questions[0][answers][3]"
                                                class="form-control mb-2" placeholder="Answer 4" required>
        ...
        function addQuestion() {
            ...
            newQuestionBlock.innerHTML = `
                <div class="card-body">
                    ...
                    <input type="text" name="questions[${questionCount}][question]" class="form-control mb-3" required>
                    ...
                    <div class="answers-section mt-3">
                        ...
                        <div class="multiple-choice-answers text-black">
                            <!-- Multiple Choice Answer Inputs -->
                            <div class="form-check mb-3">
                                <input type="text" name="questions[${questionCount}][answers][0]" class="form-control mb-2" placeholder="Answer 1" required>
                            ...
                            <div class="form-check mb-3">
                                <input type="text" name="questions[${questionCount}][answers][1]" class="form-control mb-2" placeholder="Answer 2" required>
                            ...
                            <div class="form-check mb-3">
                                <input type="text" name="questions[${questionCount}][answers][2]" class="form-control mb-2" placeholder="Answer 3" required>
                            ...
                            <div class="form-check mb-3">
                                <input type="text" name="questions[${questionCount}][answers][3]" class="form-control mb-2" placeholder="Answer 4" required>
