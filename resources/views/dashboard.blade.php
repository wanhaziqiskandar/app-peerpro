            ...
            @if (Auth::user()->isTutor())
                ...
                <div class="mx-auto mt-12 max-w-7xl sm:px-6 lg:px-8">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                        ...
                        <div
                            class="transform rounded-xl bg-gradient-to-r from-teal-400 to-blue-500 p-8 text-center text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl">
                            <div class="mb-4">
                                <svg xmlns="http://www.w3.org/2000/svg" class="mx-auto h-12 w-12" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <h3 class="mb-2 text-2xl font-semibold">Enhance Your Tutoring Skills</h3>
                            <p class="text-lg">
                                Empower your students by refining your tutoring techniques and expanding your knowledge
                                base.
                            </p>
                        </div>
